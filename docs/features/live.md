...
1. **全局默认**：在 General → Features enabled by default for new workspaces 勾选 **Live**，影响之后新增的工作区。
2. **单个工作区**：打开工作区后，在浏览器工作区设置页启用 **Live**。

CLI 只负责打开或追加工作区，不再提供单独的 Live feature flag。
